<?php 
	...
	{
		$sql_query="DELETE FROM enfil_cliente WHERE id_cliente=".$_GET['delete_id'];
  	...
  	<head>
		...
		<script type="text/javascript">
			function edt_id(id)
			{
				...
				{
					window.location.href='clientes_edit.php?edit_id='+id;
				}
			}
   	...
   	<body>
		...
		<div class="container">
			<h1>Clientes</h1>
			<hr>
			<a href="clientes_add.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Cliente</a>
		</div>
	
				<br>
		<div class="container">
			<div class="panel panel-default">
				<form class="form-horizontal" action="clientes_salvar.php" method="POST">
				  <div class="panel-body">
						...
						<tbody>
						    <?php
								...
								//cria uma variável php para ultilizar cada dado vindo do array de campos 
								//transforma o resultado (select) do sql e guarda o retorno na variável resultado
								$sql_query="SELECT * FROM enfil_cliente";
