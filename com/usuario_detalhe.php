			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-horizontal" action="usuario_salvar.php" method="POST">
						...
						<hr>					
						<div class="form-group">
							<label class="control-label col-sm-2">Ramal</label>
							<div class="col-sm-1">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="ativo">Usuario Ativo </label>
									<div class="checkbox">
									<label><input type="checkbox" value="" name="ativo[]" value="ativo"> </label>
								</div>	
						</div>	
						<hr>
						<div class="form-group">
							<label class="control-label col-sm-3" ><H3>Perfil de Acesso</H3> </label>
						</div>
						...
						<div class="form-group">        
							<div class="col-sm-offset-5 col-sm-4">
								...
								<a href="usuario_editar.php" class="btn btn-primary">Editar</a>
