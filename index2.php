...
{
	$sql_query="DELETE FROM enfil_proposta WHERE id_proposta=".$_GET['delete_id'];
									...
									if(mysql_num_rows($result_set)>0)
									{
										...
										?>
											<tr>
												...
												<td></td>
												<td></td>		
												<td align="center"><a href="javascript:edt_id_0('<?php echo $row[0]; ?>')" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a>
												<a href="javascript:edt_id('<?php echo $row[0]; ?>')" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
